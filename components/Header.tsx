  ...
  return (
    <header className="px-3 py-7 flex justify-between items-center bg-bgHeader z-10 md:px-10">
      <div className="flex justify-between items-center self-center">
        ...
        <h1 className="ml-2 text-2xl text-white font-semibold">Listencraft</h1>
      </div>
      <a
        className="text-white bg-btnColor1 py-1 px-3 rounded-3xl transition ease-in-out duration-500 hover:bg-btnColorHover z-20 sm:px-4 2xl:text-xl"
        target="_blank"
